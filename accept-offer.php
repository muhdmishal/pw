...
<span style="font-size:14px">Email Templates<br /><a class="button btn viewfull" href="email-form.php">Blank Message</a><a class="button btn viewfull" href="formal-offer.php">Make formal offer</a><a class="button btn viewfull" href="reject-offer.php">Reject Formal Offer</a></span>
			...
			<textarea tabindex="18" id="email-content" name="email-content"  rows="15" cols="80" class="basic-grey form-control " >Hi,
We would be happy to accept your offer of £100,000 subject to contract.
We will now contact our solicitors and provide them with all the details in this matter.
