...
<form class="grey" action="" method="post" enctype="">
 <div class="col-lg-12 form-back">
<span style="font-size:14px">Email Templates<br /><a class="button btn viewfull" href="email-form.php">Blank Message</a><a class="button btn viewfull" href="accept-offer.php">Accept Formal Offer</a><a class="button btn viewfull" href="reject-offer.php">Reject Formal Offer</a></span>
