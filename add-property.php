  ...
  <form role="form" action="" method="post" enctype="multipart/form-data">
    <div class="col-sm-12 form-back">
      ...
      <div class="col-xs-6 selectContainer">
		...
		<input type="text"  class="form-control add-property-input" tabindex="2" autocomplete="off" class="txtBox" id="housePCode" name="housePCode" value="" required="required" placeholder="Start typing your postcode and select from the options below"/>
...
<script>
  ...
  function initMap() {
    var input = document.getElementById('housePCode');
